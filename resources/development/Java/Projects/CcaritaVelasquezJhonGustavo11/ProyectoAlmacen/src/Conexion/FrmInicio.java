    ...
    private void iniciarSesion(String usuario, String contrasena) {
        ...
        try (PreparedStatement sentencia = conexion.prepareStatement(consultaSQL)) {
            ...
            if (resultado.next()) {
                ...
                menu.setExtendedState(FrmMenu.MAXIMIZED_BOTH);//ejecutar maximizado
            ...
            if (intentosRestantes > 0) {
                ...
                JOptionPane.showMessageDialog(this,
                    "Superaste el numero maximo de intentos de Inicio de Secion , Comuniquese con soporte porfavor.");
                System.exit(0); 
            }
        }
